...
isSameFlavour 			= n.zeros(1, dtype=int)
isOppositeFlavour 		= n.zeros(1, dtype=int)
...
t.Branch("isSameFlavour", isSameFlavour, "isSameFlavour/I")
t.Branch("isOppositeFlavour", isOppositeFlavour, "isOppositeFlavour/I")
...
t.Branch('Process', Process, 'Process[21]/C')
...
for s in signals+data:
  ...
  for ev in range(nEvents):
    ...
    if len(leptons)==2: 
      ...
      if  mll>20 and abs(mll-90.2)<15 and nbjets[0]>0 and nleptons[0]>1 and njets[0]>1:  
