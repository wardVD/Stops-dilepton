...
signal = [SMS_T2tt_2J_mStop650_mLSP325]
...
if bkgtot > 0: baselineamount['SoverB'] = 1000* sigtot/bkgtot
...
for cuttype in cutflow.keys(): 
  for cut in cutflow[cuttype]['cuts']:
    ...
    if bkgtot > 0: cutflow[cuttype]['cuts'][cut]['SoverB'] = 1000 * sigtot/bkgtot
